...
4. **Clone the Repository and Install Dependencies:**
   ...
   ```sh
   git clone https://github.com/lyfe00011/destructor-xmd botName
   cd botName
   yarn install
   ```
...
- [Bot Environment Variables](https://destructor-xmd-plugins.vercel.app/env)  
- [Frequently Asked Questions](https://destructor-xmd-plugins.vercel.app/faq)
